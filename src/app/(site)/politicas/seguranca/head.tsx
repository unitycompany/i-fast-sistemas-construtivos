...
const pathname = "/politicas/seguranca";

export default function Head() {
  const title = `Política de Segurança | ${SITE_NAME}`;
  const description =
    "Conheça práticas e medidas de segurança adotadas para proteger informações e reduzir riscos no uso do site.";

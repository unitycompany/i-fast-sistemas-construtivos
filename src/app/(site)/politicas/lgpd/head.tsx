...
const pathname = "/politicas/lgpd";

export default function Head() {
  const title = `Central LGPD | ${SITE_NAME}`;
  const description =
    "Central LGPD: direitos do titular, canais de atendimento e informações sobre o tratamento de dados pessoais pela Fast.";

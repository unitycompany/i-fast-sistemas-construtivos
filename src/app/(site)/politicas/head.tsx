...
const pathname = "/politicas";

export default function Head() {
  const title = `Políticas | ${SITE_NAME}`;
  const description =
    "Acesse as políticas e documentos oficiais da Fast: privacidade, cookies, termos de uso, central LGPD e segurança.";
